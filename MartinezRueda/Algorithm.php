...
include_once('MartinezRueda/Connector.php');
include_once('MartinezRueda/Contour.php');
include_once('MartinezRueda/Debug.php');
include_once('MartinezRueda/Helper.php');
include_once('MartinezRueda/Point.php');
include_once('MartinezRueda/PointChain.php');
include_once('MartinezRueda/Polygon.php');
include_once('MartinezRueda/PriorityQueue.php');
include_once('MartinezRueda/Segment.php');
include_once('MartinezRueda/SweepEvent.php');
include_once('MartinezRueda/SweepLine.php');
