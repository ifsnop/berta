...
/**
 * Utilizando la lÃ³gica del SASS-C, busca un fichero recording_details.par y
 * obtiene los radares configurados para la evaluaciÃ³n. Luego busca en el
 * directorio donde estÃ©n definidos todos los radares y extrae, dependiendo
 * de $parse_all, o bien de todos o bien de sÃ³lo los definidos en la
 * evaluaciÃ³n, un array con la informaciÃ³n.
 *
 * @param string $eval_dir Directorio donde estÃ¡ configurada la evaluaciÃ³n
